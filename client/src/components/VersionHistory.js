...
const versionHistory = [
  {
    version: "V1.5",
    title: "Creación modelo SaaS de (U)Boost",
    date: "Marzo 2025",
    icon: <CloudIcon />,
    features: [
      "Sistema de límites de almacenamiento (200 MB por usuario)",
      "Integración con AWS S3 para almacenamiento en la nube",
      "Gestión de cuotas personalizables por usuario",
      "Monitoreo visual de espacio disponible",
      "Registro preciso de costes por modelo (OpenAI/Claude)",
      "Descarga de documentos en formatos TXT y MD"
    ],
    highlight: true
  },
  {
    version: "V.11",
    title: "Panel de (U)Boost",
    date: "Marzo 2025",
    icon: <SettingsIcon />,
    features: [
      "Panel de control para administradores del sistema",
      "Gestión de usuarios (aprobación, pausa, eliminación)",
      "Vista completa de todos los usuarios registrados",
      "Métricas de uso y consumo de tokens"
    ],
    highlight: true
  },
  {
    ...
    features: [
      "Implementación de estados de usuario: pendiente, aprobado, pausado, eliminado",
      "Proceso de autorización para nuevos usuarios",
  ...
  return (
    <>
      ...
      >
        ...
        <Box component="span" sx={{ display: { xs: 'none', sm: 'inline' } }}>Versiones</Box>
      </Button>
