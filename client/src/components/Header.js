        ...
        <Toolbar>
          <Box sx={{ display: 'flex', alignItems: 'center', flexGrow: 1 }}>
            ...
            <Typography 
              ...
              to={currentUser ? "/" : "/landing"}
              sx={{ fontWeight: 700, textDecoration: 'none', color: 'inherit', display: 'flex', alignItems: 'center' }}
            >
              (U)Boost
            </Typography>
            <Typography 
              variant="subtitle1"
              sx={{ ml: 1, fontWeight: 400, color: 'rgba(255, 255, 255, 0.85)', display: { xs: 'none', sm: 'block' } }}
            >
              scientific paper
            </Typography>
            ...
            {currentUser && (
              <Typography 
                variant="subtitle1"
                sx={{ ml: 3, fontWeight: 500, color: 'rgba(255, 255, 255, 0.95)', display: { xs: 'none', md: 'block' } }}
              >
                {currentUser.email}
              </Typography>
            )}
          ...
          <Stack direction="row" spacing={1.5} sx={{ ml: 2 }}>
            ...
            {currentUser && (
              ...
              >
                ...
                <Box component="span" sx={{ display: { xs: 'none', sm: 'inline' } }}>Historial</Box>
              </Button>
            )}
            <Button 
              color="inherit"
            ...
            >
              <GavelIcon sx={{ mr: 0.5 }} />
              <Box component="span" sx={{ display: { xs: 'none', sm: 'inline' } }}>Legal</Box>
            </Button>
            <Button 
              color="inherit"
