...
// Lista de todos los países del mundo - ISO 3166-1
const countries = [
...
/**
 * Componente selector de países con autocompletado
 */
const CountrySelector = ({ value, onChange, error, helperText, required = false }) => {
  return (
    <Autocomplete
      id="country-select"
      options={countries}
      fullWidth
      autoHighlight
      value={value ? countries.find(country => country.label === value || country.code === value) || null : null}
      ...
      renderInput={(params) => (
        <TextField
          ...
          inputProps={{
            ...params.inputProps,
            autoComplete: 'new-password', // Deshabilita autocompletado del navegador
          }}
        />
      )}
    />
